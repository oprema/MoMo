...
class MovementTimeout extends Component {
  sideBySide() {
    return (
      <g viewBox="0 0 90 90">
        <path id="SideBySide" d="M88.621,35.316c-3.438,6.591-10.616,8.598-17.634,12.282c0,5.189,0,12.215,0,14.227
          ...
          C22.561,29.96,27.008,34.417,32.499,34.417z" fill="#FFF" transform="scale(0.25) translate(28, 28)"/>
      </g>
    );
  }
  ...
  render() {
    ...
    const percentage = parseInt(this.props.percentage, 10);

    let backGround = styles.circularChartGreen;
    if (percentage > 80 && percentage < 100) {
      backGround = styles.circularChartOrange;
    } else if (percentage >= 100) {
      backGround = styles.circularChartRed;
    }
...
MovementTimeout.propTypes = {
  percentage: PropTypes.string,
};

MovementTimeout.defaultProps = {
  percentage: '0',
};

export default MovementTimeout;
